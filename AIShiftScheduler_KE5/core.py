...
# %% auto 0
__all__ = ['ThetasCumSlots', 'ThetasSickProb', 'ThetasCumMerits', 'ThetasSelect', 'thetas_list', 'Thetas', 'start', 'L', 'T',
           'First_n_t', 'Last_n_t', 'ThetaStar_expCbarcum_Alloc', 'ThetaStar_expCtilcum_Alloc', 'Cbarcum_Alloc',
           'Ctilcum_Alloc', 'Best_theta_Alloc', 'Worst_theta_Alloc', 'Best_Cbarcum_Alloc', 'Worst_Cbarcum_Alloc',
           'Best_Ctilcum_Alloc', 'Worst_Ctilcum_Alloc', 'Record_Alloc', 'Df_first_n_t', 'Df_last_n_t', 'end',
           'ThetaStar_expCbarcum_Alloc_evalu_opt', 'ThetaStar_expCtilcum_Alloc_evalu_opt', 'Best_theta_Alloc_evalu_opt',
           'Worst_theta_Alloc_evalu_opt', 'Record_Alloc_evalu_opt', 'Df_Alloc_evalu_opt',
